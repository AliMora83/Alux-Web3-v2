  ...
  return (
    <main className="mt-5 space-y-5">
      <form className="flex flex-col space-y-6">
        ...
        <div>
          <label htmlFor="about" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            About page here
          </label>
        </div>
      </form>
      ...
      <p className="text-xs flex space-x-1 items-center text-[#0EA7E6]">
        ...
        />
        <span>By add ing an item to the marketplace, you&lsquo;re essentially Minting an NFT of the item into your wallet which can then list for sale!</span>
      </p>
    </main>
  );
}
