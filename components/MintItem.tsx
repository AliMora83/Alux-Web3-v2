        ...
        <main className="mt-5 space-y-5">
                        ...
                        <div className="flex flex-col justify-center items-center space-y-4">
                            ...
                            {galleryImages.length > 0 ? (
                                <button
                                    ...
                                    className="bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0EA7E6]"
                                >
                                    <span className="cursor-pointer py-2 px-3 inline-flex">
                                        Remove Images
                                    </span>
                                </button>
                            ) : (
            ...
            <p className="text-xs flex space-x-1 items-center text-gray-400">
                ...
                <span className="md:w-4/5">
                    By adding your NFT Property here, you're Minting an NFT of
                    the Property onto your wallet which may then be listed for
                    sale on Alux Web3 Marketplace!
                </span>
            </p>
        </main>
    );
