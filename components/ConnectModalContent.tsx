    ...
    <div className="max-w-[300px]">
      {!address ? (
        <div className="space-y-3">
          ...
          <div className="flex flex-col space-y-2">
            <button
              ...
              className="py-3 text-sm bg-[#0f5573] text-white rounded-md"
            >
              Connect Metamask
            </button>
            <button
        ...
        <div className="space-y-5">
          ...
          <button
            className="px-5 py-2 rounded border-2 border-[#0f5573] text-[#0EA7E6] hover:bg-[#0EA7E6] hover:text-white transition-colors duration-300 flex space-x-1 items-center"
            onClick={() => {
              disconnect();
              closeModal();
            }}
